...
def update_state(state, kernel, learning_rate, x_i, y_i):
    ...
    new_weight=learning_rate*(y_i-prediction)
    state.append((new_weight,x_i))
    # *** END CODE HERE ***
...
def invalid_kernel(a, b):
    return -1 if np.all(a==b) else 0
...
def main():
    ...
    train_perceptron('invalid', invalid_kernel, 0.5)
